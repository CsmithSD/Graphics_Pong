...
float Entity3D::get_z(){ return z; }
float Entity3D::get_roll(){ return roll; }
float Entity3D::get_pitch(){ return pitch; }

void Entity3D::set_z( float z ){ this.z = z; }
void Entity3D::set_roll(float roll) { this.roll = roll}
void Entity3D::set_pitch( float pitch ){ this.pitch = pitch }
